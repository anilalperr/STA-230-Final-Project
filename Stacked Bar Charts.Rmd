...
```{R}
#grade, gender, time.work, time.no.adult, time.school.act, time.reading
set.seed(123)
sub_project_data = dplyr::select(project_data, grade, gender, time.work, time.no.adult, time.school.act, time.reading, time.HW)
