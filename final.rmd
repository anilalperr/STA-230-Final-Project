...
project_data[project_data == "Strongly agree"] = "Agree"
project_data[project_data == "Strongly disagree"] = "Disagree"
sub_project_data = dplyr::select(project_data, gender, time.no.adult, time.friend, time.school.act, time.reading, time.church, time.excersize, time.HW)
...
project_data[project_data == "Strongly agree"] = "Agree"
project_data[project_data == "Strongly disagree"] = "Disagree"
sub_project_data = dplyr::select(project_data, gender, time.work, time.no.adult, time.friend, time.school.act, time.reading, time.church, time.excersize, time.HW)
